...
public final class YouTubeWebViewFragment extends Fragment implements YouTubeBaseFragment, YouTubeEventListener, YouTubePlayer.OnFullscreenListener {
    ...
    public void onFullscreen(boolean b) {
        if (youTubeEventListener != null) {
            youTubeEventListener.onFullscreen(b);
        }
    }
}
